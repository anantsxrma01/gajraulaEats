  ...
  Future<void> _sendOtp() async {
    ...
    try {
      ...
      if (res.statusCode == 200) {
        ...
        setState(() => _error = jsonDecode(res.body)['message'] ?? 'Failed to send OTP');
      }
    } catch (_) {
      ...
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xFF1A0A0A), Color(0xFF09090B)],
          ),
        ),
        child: SafeArea(
          child: Padding(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [BoxShadow(color: const Color(0xFFEF4444).withOpacity(0.4), blurRadius: 24, spreadRadius: 0)],
                  ),
                  child: const Center(child: Text('🍕', style: TextStyle(fontSize: 26))),
                ),
                const SizedBox(height: 24),
                Text(
                  _isOtpStep ? 'Enter OTP' : 'Welcome Back!',
                  style: const TextStyle(fontSize: 30, fontWeight: FontWeight.w800, color: Colors.white),
                ),
                const SizedBox(height: 6),
                Text(
                  _isOtpStep
                    ? 'We sent a 4-digit code to +91 ${_phoneCtrl.text}'
                    : 'Sign in to order from Gajraula\'s best restaurants',
                    ...
                    child: Row(
                      children: [
                        Container(
                          ...
                          decoration: const BoxDecoration(
                            border: Border(right: BorderSide(color: Color(0xFF3F3F46))),
                          ),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _loading
                      ...
                      : Text(
                          _isOtpStep ? 'Verify & Continue' : 'Send OTP',
